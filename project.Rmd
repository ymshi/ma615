...
#tidy data
#According to the article "TidyData", the observations should on the right hand side, and the treatments should form a column. (I consolut my classmate Jiaxin Sun for the following code, line 42-line 52)
oil <- 
